...
! function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showPaginationSwitch) {
            html.push(sprintf('<button class="btn btn-info" type="button" name="paginationSwitch" title="%s">',
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-info' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="refresh" title="%s">',
        ...
        if (this.options.showToggle) {
            html.push(sprintf('<button class="btn btn-info' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="toggle" title="%s">',
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                '<button type="button" class="btn btn-info' + (this.options.iconSize == undefined ? '' : ' btn-' + this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
